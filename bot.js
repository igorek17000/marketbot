...
function sendDelayedMessage(msg, attachments, botID, res, NAME) {
  setTimeout(function() {
    postMessage(msg, attachments, botID, res, NAME);
  }, config.delay_time);
}

function postMessage(botResponse, attachments, botID, res, NAME) {
