...
global.customerSchema = new mongoose.Schema({ name: String, password: String }); 
...
var jokeBot      = require('./custom_commands/jokebot');
...
var checkCommandsHSH = [alexBot, jokeBot, flynnBot, emailBot, birthdayBot, api, mods, sysTriggers, userCmds, userMentions, sysCommands, atEveryone, funCommands, quotes, rooms, gif, catFact, urbanDict];
