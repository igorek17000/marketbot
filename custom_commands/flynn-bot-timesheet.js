...
//continue;
     ...
     var flynnbReg = new RegExp(flynnb.regex, "i") || var flynnbReg = new RegExp(flynnb.regexcurrent, "i"); 
...
function addFlynnBotCmd(request, bots, isMod, callback) {
  ...
  if (regex.test(reqText)){
    ...
    var msg = "FlynnBot timesheet added and current week updated! Use '/timesheet describe' " + flynnbot[flynnb].name + " to add a description";
    callback(true, msg, []);
    return msg;
  }
}
