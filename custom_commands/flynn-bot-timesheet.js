...
function updateFlynnBotCurrent(flynnb, callback) {
  db.updateOneDoc(db_table, { "current": flynnb.current }, { $rename: { "current": "lastUpdate", "regexcurrent": "completed" }}, { "lastUpdate": flynnb.lastUpdate, "completed": flynnb.completed }, { $set: { "lastUpdate": date, "completed": date }}, callback);
}
