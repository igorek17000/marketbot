...
function addFlynnBotCmd(request, bots, isMod, rooms, callback) {
...
//if (rooms.getARoom(botRoom) == true) { //&& botRoom == '308boonbot') { //flynnbot[flynnb].bots.indexOf(getARoom.type) > -1 && botRoom == 'true') {
botName = rooms.getARoom(rooms[path]); //(botRoom).type; //botRoom; 
