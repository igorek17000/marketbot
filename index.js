...
if (request.headers.host != 'www.marketbotai.com') || if (process.env.NODE_ENV != 'development' && !request.secure) {
...
res.setHeader('Content-type', 'text/html');
var html = fs.readFileSync(path.join(__dirname + "/views/hcaptchabutton.ejs")); //hcaptchabutton.ejs
res.render('aimarketing.ejs'); //hcaptchabutton.ejs');
});
