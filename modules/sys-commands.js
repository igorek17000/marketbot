...
var ns = require('./modules/nest18.js');
...
return item; (item.id, item.name, item.group_id); 
}); 
//console.log(items);
...
//var result = Object.keys(json.res).forEach(key => { callback(key, result[key]); });
