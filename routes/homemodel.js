...
res.render('image.ejs', {image: docs}); //docs['contentType'] + ';' + docs['data']});
...
var id = '60235c64d1e4d5001aa0760c';
	router.getImages(images, (err, items) => {
...
res.render("images.ejs", {images: items}); //"data:" + docs['contentType'] + ";base64," + base64ArrayBuffer(docs['data'])}); //<%=image.img.contentType%>;base64, 
