...
res.render("image.ejs", {image: 'data:image/' + docs['contentType'] + ';base64,' + docs['data'].toString('base64')}); //base64ArrayBuffer(docs['data'])}); //<%=image.img.contentType%>;base64, 
